...
<!-- css시트를 적용할때 위에서부터 아래로 적용되어 동일한 곳에 -->
<!-- 적용되는 코드는 최종적으로 아래부분의 css로 덮어쓴다 -->
...
<div id="bbs">
	...
	<form action="" name="myForm" method="post">
				...
				<dl>
					...
					<dt>내&nbsp;&nbsp;&nbsp;&nbsp;용</dt>
						...
						<dd>
							...
							class="boxTA" style="resize: none; background-color: #ffffff;"></textarea>
		...
		<div id="bbsCreated_footer">
			...
			<input type="button" value=" 작성 취소 " class="btn2"
